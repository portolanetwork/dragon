...
export class GrpcWebFetchTransport implements RpcTransport {
    ...
    serverStreaming<I extends object, O extends object>(method: MethodInfo<I, O>, input: I, options: RpcOptions): ServerStreamingCall<I, O> {
        ...
        globalThis.fetch(url, {
            ...
            body: createGrpcWebRequestBody(inputBytes, format) as BodyInit,
    ...
    unary<I extends object, O extends object>(method: MethodInfo<I, O>, input: I, options: RpcOptions): UnaryCall<I, O> {
        ...
        globalThis.fetch(url, {
            ...
            .then(() => {
                ...
                //if (!maybeMessage)
                //    throw new RpcError(maybeStatus.detail, maybeStatus.code, maybeTrailer);
                maybeStatus = maybeStatus || {code: 'OK', detail: 'OK'};

                //defMessage.resolve(maybeMessage);
                if (maybeMessage) {
                    defMessage.resolve(maybeMessage);
                } else {
                    defMessage.reject(new RpcError('No message received', GrpcStatusCode[GrpcStatusCode.DATA_LOSS]));
                }
