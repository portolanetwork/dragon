 ...
 *
 * @generated from protobuf message dragon.turnstile.v1.Filter
 */
export interface Filter {
    /**
     * @generated from protobuf field: string event_type = 30
     */
    eventType: string;
}
/**
 ...
 *
 * @generated from protobuf message dragon.turnstile.v1.GetEventLogRequest
 */
export interface GetEventLogRequest {
    /**
     * @generated from protobuf field: dragon.turnstile.v1.Filter filter = 10
     */
    filter?: Filter;
    /**
     * @generated from protobuf field: string cursor = 20
     */
    cursor: string; // Cursor for pagination (timestamp-based)
    /**
     * @generated from protobuf field: int32 page_size = 30
     */
    pageSize: number; // Number of events per page (default: 100, max: 1000)
}
/**
 * Response containing list of event logs
 *
 * @generated from protobuf message dragon.turnstile.v1.EventLogList
 */
export interface EventLogList {
    /**
     * @generated from protobuf field: repeated dragon.turnstile.v1.EventLog event_log = 10
     */
    eventLog: EventLog[];
    /**
 ...
 *
 * @generated from protobuf message dragon.turnstile.v1.EventLog
 */
export interface EventLog {
    /**
     * @generated from protobuf field: int64 id = 10
     */
    id: bigint; // Database primary key
    /**
     * @generated from protobuf field: string uuid = 20
     */
    uuid: string; // Globally unique event identifier
    /**
     * @generated from protobuf field: string tenant = 30
     */
    tenant: string; // Tenant identifier
    /**
     * @generated from protobuf field: string user_id = 40
     */
    userId: string; // User who performed the action (optional for system events)
    /**
     * @generated from protobuf field: string event_type = 50
     */
    eventType: string; // Event type (e.g., TOOL_EXECUTED, MCP_REQUEST_PROCESSED)
    /**
     * @generated from protobuf field: string description = 60
     */
    description: string; // Human-readable event description
    /**
     * @generated from protobuf field: google.protobuf.Struct metadata = 70
     */
    metadata?: Struct; // Event-specific structured data (JSONB)
    /**
     * @generated from protobuf field: google.protobuf.Timestamp created_at = 80
     */
...
class McpServerList$Type extends MessageType<McpServerList> {
    constructor() {
        super("dragon.turnstile.v1.McpServerList", [
            { no: 10, name: "mcp_server", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => McpServer }
        ]);
    }
...
class Filter$Type extends MessageType<Filter> {
    constructor() {
        super("dragon.turnstile.v1.Filter", [
            { no: 30, name: "event_type", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    ...
    internalBinaryWrite(message: Filter, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.eventType !== "")
            writer.tag(30, WireType.LengthDelimited).string(message.eventType);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message dragon.turnstile.v1.Filter
 */
export const Filter = new Filter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetEventLogRequest$Type extends MessageType<GetEventLogRequest> {
    constructor() {
        super("dragon.turnstile.v1.GetEventLogRequest", [
            { no: 10, name: "filter", kind: "message", T: () => Filter },
            { no: 20, name: "cursor", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 30, name: "page_size", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    ...
    internalBinaryWrite(message: GetEventLogRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* dragon.turnstile.v1.Filter filter = 10; */
        if (message.filter)
            Filter.internalBinaryWrite(message.filter, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
        /* string cursor = 20; */
        if (message.cursor !== "")
            writer.tag(20, WireType.LengthDelimited).string(message.cursor);
        /* int32 page_size = 30; */
        if (message.pageSize !== 0)
            writer.tag(30, WireType.Varint).int32(message.pageSize);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message dragon.turnstile.v1.GetEventLogRequest
 */
export const GetEventLogRequest = new GetEventLogRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class EventLogList$Type extends MessageType<EventLogList> {
    constructor() {
        super("dragon.turnstile.v1.EventLogList", [
            { no: 10, name: "event_log", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => EventLog },
            { no: 20, name: "next_cursor", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<EventLogList>): EventLogList {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.eventLog = [];
        message.nextCursor = "";
        if (value !== undefined)
            reflectionMergePartial<EventLogList>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: EventLogList): EventLogList {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated dragon.turnstile.v1.EventLog event_log */ 10:
                    message.eventLog.push(EventLog.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: EventLogList, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated dragon.turnstile.v1.EventLog event_log = 10; */
        for (let i = 0; i < message.eventLog.length; i++)
            EventLog.internalBinaryWrite(message.eventLog[i], writer.tag(10, WireType.LengthDelimited).fork(), options).join();
...
/**
 * @generated MessageType for protobuf message dragon.turnstile.v1.EventLogList
 */
export const EventLogList = new EventLogList$Type();
// @generated message type with reflection information, may provide speed optimized methods
class EventLog$Type extends MessageType<EventLog> {
    constructor() {
        super("dragon.turnstile.v1.EventLog", [
            { no: 10, name: "id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 20, name: "uuid", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 30, name: "tenant", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 40, name: "user_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 50, name: "event_type", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 60, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 70, name: "metadata", kind: "message", T: () => Struct },
            { no: 80, name: "created_at", kind: "message", T: () => Timestamp }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string uuid */ 20:
                    message.uuid = reader.string();
                    break;
                case /* string tenant */ 30:
                    message.tenant = reader.string();
                    break;
                case /* string user_id */ 40:
                    message.userId = reader.string();
                    break;
                case /* string event_type */ 50:
                    message.eventType = reader.string();
                    break;
                case /* string description */ 60:
                    message.description = reader.string();
                    break;
                case /* google.protobuf.Struct metadata */ 70:
    ...
    internalBinaryWrite(message: EventLog, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* string uuid = 20; */
        if (message.uuid !== "")
            writer.tag(20, WireType.LengthDelimited).string(message.uuid);
        /* string tenant = 30; */
        if (message.tenant !== "")
            writer.tag(30, WireType.LengthDelimited).string(message.tenant);
        /* string user_id = 40; */
        if (message.userId !== "")
            writer.tag(40, WireType.LengthDelimited).string(message.userId);
        /* string event_type = 50; */
        if (message.eventType !== "")
            writer.tag(50, WireType.LengthDelimited).string(message.eventType);
        /* string description = 60; */
        if (message.description !== "")
            writer.tag(60, WireType.LengthDelimited).string(message.description);
        /* google.protobuf.Struct metadata = 70; */
        if (message.metadata)
            Struct.internalBinaryWrite(message.metadata, writer.tag(70, WireType.LengthDelimited).fork(), options).join();
        /* google.protobuf.Timestamp created_at = 80; */
        if (message.createdAt)
            Timestamp.internalBinaryWrite(message.createdAt, writer.tag(80, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
...
/**
 * @generated MessageType for protobuf message dragon.turnstile.v1.EventLog
 */
...
export const TurnstileService = new ServiceType("dragon.turnstile.v1.TurnstileService", [
    ...
    { name: "GetEventLog", options: {}, I: GetEventLogRequest, O: EventLogList }
]);
